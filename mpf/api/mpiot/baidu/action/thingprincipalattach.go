...
type thingPrincipalAttach struct {
    mpiot.BaseBaiDu
...
func (tpa *thingPrincipalAttach) SetEndpointName(endpointName string) {
...
func (tpa *thingPrincipalAttach) SetThingName(thingName string) {
...
func (tpa *thingPrincipalAttach) SetPrincipalName(principalName string) {
...
func (tpa *thingPrincipalAttach) CheckData() (*fasthttp.Client, *fasthttp.Request) {
